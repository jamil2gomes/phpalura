<form method="POST" >
   <input type="hidden" name="id" value="<?=$contato->getId();?>">
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="nome" name="nome" value="<?=htmlentities($contato->getNome());?>">
    </div>
    ...
    <div class="form-group">
        ...
        <input type="tel" class="form-control" id="telefone" name="telefone" pattern="/\(\d{2}\)\ \d{4}\-\d{4}/" value="<?=htmlentities($contato->getTelefone());?>" placeholder="(XX)XXXX-XXXX">
    </div>
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="cep" name="cep" value="<?=htmlentities($contato->getCEP());?>" placeholder="XX.XXX-XXX">
    </div>
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="cpf" name="cpf" value="<?=htmlentities($contato->getCPF());?>" placeholder="XXX.XXX.XXX-XX">
    </div>

    <div class="form-group">
        <label for="email">Email</label>
        <input type="email" class="form-control" id="email" name="email" value="<?=htmlentities($contato->getEmail());?>">
    </div>

    <div class="form-group">
        <label for="descricao">Descrição</label>
        <textarea  class="form-control" name="descricao" id="descricao" value="<?=htmlentities($contato->getDescricao());?>" ></textarea>
    </div>
