<form method="POST" >
   <input type="hidden" name="id" value="<?=$contato['id']?>">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="telefone" name="telefone" value="<?=$contato['telefone']?>" placeholder="(XX)XXXX-XXXX">
    </div>
    ...
    <div class="form-group">
        ...
        <input type="data" class="form-control" id="dataNascimento" name="dataNascimento" value="<?=traduz_data_para_exibir($contato['dataNascimento'])?>" placeholder="dd/mm/aaaa">
    </div>
